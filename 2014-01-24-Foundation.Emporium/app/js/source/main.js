(function(){
  ...
  function updateTotals(){
    ...
    var numa= transformTdsToNumbers($amounts);
    var numt= transformTdsToNumbers($totals);
    var sumAmounts = sum(numa);
    var sumTotals = sum(numt);
    $('table > tfoot > tr > td:nth-child(3)').text(numberToCurrency(sumAmounts));
    $('table > tfoot > tr > td:nth-child(4)').text(numberToCurrency(sumTotals));
  }
